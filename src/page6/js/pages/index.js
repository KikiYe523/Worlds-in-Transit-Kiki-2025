...
export default class Index {
  constructor() {
    ...
    this.sources = [
      {
        type: "model",
        src: `${import.meta.env.VITE_MODEL_PATH_PREFIX}/model/cat6.glb`,
        detail:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page6/image-1.JPG",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page6/image-2.JPG",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page6/image-3.JPG",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page6/image-4.PNG",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page6/image-5.jpg",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page6/image-6.JPG",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page6/video-1.mp4",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page6/video-2.mp4",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page6/video-3.MP4",
        caption:
          "Production Fun Fact (Eggs) <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2024",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page6/image-7.jpg",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page6/image-8.jpg",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page6/image-9.jpg",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
    ];
    this.data = [
      { x: 1940, y: 1050, w: 420, h: 320 },
      { x: 330, y: 255, w: 350, h: 460 },
      { x: 831, y: 158, w: 200, h: 300 },
      { x: 2121, y: 200, w: 300, h: 400 },
      { x: 1974, y: 687, w: 260, h: 290 },
      { x: 2523, y: 1024, w: 205, h: 300 },
      { x: 911, y: 540, w: 260, h: 280 },
      { x: 1451, y: 903, w: 250, h: 400 },
      { x: 1371, y: 422, w: 350, h: 260 },
      { x: -67, y: 444, w: 260, h: 320 },
      { x: 511, y: 922, w: 205, h: 400 },
      { x: 911, y: 1130, w: 205, h: 400 },
      { x: 1311, y: 23, w: 205, h: 300 },
    ];
    // 获取id为hero的元素，设置背景为一段视频src\static\img\page6\bg1.MP4
    // const hero = document.querySelector("#hero");
    // hero.style.background = `url('../../static/img/page6/bg1.MP4') no-repeat center center`;
