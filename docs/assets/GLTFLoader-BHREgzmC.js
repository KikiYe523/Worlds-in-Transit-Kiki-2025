...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ci,depthTest:!1,depthWrite:!1})}function Qh(){return new fi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ka(),fragmentShader:`
		...
		`,blending:ci,depthTest:!1,depthWrite:!1})}function eu(){return new fi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ka(),fragmentShader:`
...
`].filter(xr).join(`
`)),a=zl(a),a=uu(a,t),a=fu(a,t),o=zl(o),o=uu(o,t),o=fu(o,t),a=du(a),o=du(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
