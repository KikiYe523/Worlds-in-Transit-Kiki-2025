...
export default class Index {
  constructor() {
    ...
    this.sources = [
      {
        type: "model",
        src: `${import.meta.env.VITE_MODEL_PATH_PREFIX}/model/cat7.glb`,
        detail:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page7/image-1.jpg",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page7/image-2.jpg",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page7/image-3.PNG",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page7/image-4.jpg",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page7/image-5.jpg",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page7/image-6.jpg",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page7/video-1.MP4",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page7/video-2.MP4",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page7/video-3.mp4",
        caption:
          "Production Fun Fact (Eggs) <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2024",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page7/image-7.jpg",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page7/image-8.jpg",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page7/video-4.MP4",
        caption:
          "Production Fun Fact (Eggs) <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2024",
      },
    ];
    this.data = [
      { x: -50, y: -10, w: 420, h: 320 },
      { x: 330, y: 255, w: 350, h: 460 },
      { x: 831, y: 158, w: 200, h: 200 },
      { x: 1921, y: 250, w: 300, h: 400 },
      { x: 1774, y: 887, w: 260, h: 290 },
      { x: 2223, y: 1024, w: 300, h: 205 },
      { x: 911, y: 540, w: 260, h: 280 },
      { x: 1251, y: 1003, w: 300, h: 300 },
      { x: 1371, y: 422, w: 300, h: 300 },
      { x: -67, y: 444, w: 260, h: 350 },
      { x: 511, y: 922, w: 205, h: 400 },
      { x: 911, y: 1130, w: 300, h: 150 },
      { x: 1311, y: 23, w: 350, h: 260 },
    ];
    // 获取id为hero的元素，设置背景为一段视频src\static\img\page7\bg1.MP4
    // const hero = document.querySelector("#hero");
    // hero.style.background = `url('../../static/img/page7/bg1.MP4') no-repeat center center`;
