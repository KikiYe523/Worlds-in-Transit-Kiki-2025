...
`)+`
`+p);const v=M+m+a,S=M+p+o,A=id(i,i.VERTEX_SHADER,v),E=id(i,i.FRAGMENT_SHADER,S);i.attachShader(x,A),i.attachShader(x,E),t.index0AttributeName!==void 0?i.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function w(P){if(r.debug.checkShaderErrors){const N=i.getProgramInfoLog(x)||"",F=i.getShaderInfoLog(A)||"",B=i.getShaderInfoLog(E)||"",V=N.trim(),k=F.trim(),Y=B.trim();let W=!0,ee=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(W=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,x,A,E);else{const $=rd(i,A,"vertex"),ge=rd(i,E,"fragment");He("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
...
}`;function Bb(r,e,t){let n=new fh;const i=new ue,s=new ue,a=new $e,o=new R0({depthPacking:gm}),l=new C0,c={},h=t.maxTextureSize,u={[wi]:ln,[ln]:wi,[$n]:$n},d=new St({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ue},radius:{value:4}},vertexShader:Fb,fragmentShader:Ob}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new Kt;g.setAttribute("position",new Vt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new fn(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Hd;let p=this.type;this.render=function(E,w,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||E.length===0)return;const _=r.getRenderTarget(),b=r.getActiveCubeFace(),P=r.getActiveMipmapLevel(),N=r.state;N.setBlending(Xn),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const F=p!==bi&&this.type===bi,B=p===bi&&this.type!==bi;for(let V=0,k=E.length;V<k;V++){const Y=E[V],W=Y.shadow;if(W===void 0){ve("WebGLShadowMap:",Y,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;i.copy(W.mapSize);const ee=W.getFrameExtents();if(i.multiply(ee),s.copy(W.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(s.x=Math.floor(h/ee.x),i.x=s.x*ee.x,W.mapSize.x=s.x),i.y>h&&(s.y=Math.floor(h/ee.y),i.y=s.y*ee.y,W.mapSize.y=s.y)),W.map===null||F===!0||B===!0){const ge=this.type!==bi?{minFilter:bt,magFilter:bt}:{};W.map!==null&&W.map.dispose(),W.map=new kt(i.x,i.y,ge),W.map.texture.name=Y.name+".shadowMap",W.camera.updateProjectionMatrix()}r.setRenderTarget(W.map),r.clear();const $=W.getViewportCount();for(let ge=0;ge<$;ge++){const Te=W.getViewport(ge);a.set(s.x*Te.x,s.y*Te.y,s.x*Te.z,s.y*Te.w),N.viewport(a),W.updateMatrices(Y,ge),n=W.getFrustum(),S(w,C,W.camera,Y,this.type)}W.isPointLightShadow!==!0&&this.type===bi&&M(W,C),W.needsUpdate=!1}p=this.type,m.needsUpdate=!1,r.setRenderTarget(_,b,P)};function M(E,w){const C=e.update(x);d.defines.VSM_SAMPLES!==E.blurSamples&&(d.defines.VSM_SAMPLES=E.blurSamples,f.defines.VSM_SAMPLES=E.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new kt(i.x,i.y)),d.uniforms.shadow_pass.value=E.map.texture,d.uniforms.resolution.value=E.mapSize,d.uniforms.radius.value=E.radius,r.setRenderTarget(E.mapPass),r.clear(),r.renderBufferDirect(w,null,C,d,x,null),f.uniforms.shadow_pass.value=E.mapPass.texture,f.uniforms.resolution.value=E.mapSize,f.uniforms.radius.value=E.radius,r.setRenderTarget(E.map),r.clear(),r.renderBufferDirect(w,null,C,f,x,null)}function v(E,w,C,_){let b=null;const P=C.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(P!==void 0)b=P;else if(b=C.isPointLight===!0?l:o,r.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const N=b.uuid,F=w.uuid;let B=c[N];B===void 0&&(B={},c[N]=B);let V=B[F];V===void 0&&(V=b.clone(),B[F]=V,w.addEventListener("dispose",A)),b=V}if(b.visible=w.visible,b.wireframe=w.wireframe,_===bi?b.side=w.shadowSide!==null?w.shadowSide:w.side:b.side=w.shadowSide!==null?w.shadowSide:u[w.side],b.alphaMap=w.alphaMap,b.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,b.map=w.map,b.clipShadows=w.clipShadows,b.clippingPlanes=w.clippingPlanes,b.clipIntersection=w.clipIntersection,b.displacementMap=w.displacementMap,b.displacementScale=w.displacementScale,b.displacementBias=w.displacementBias,b.wireframeLinewidth=w.wireframeLinewidth,b.linewidth=w.linewidth,C.isPointLight===!0&&b.isMeshDistanceMaterial===!0){const N=r.properties.get(b);N.light=C}return b}function S(E,w,C,_,b){if(E.visible===!1)return;if(E.layers.test(w.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&b===bi)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,E.matrixWorld);const F=e.update(E),B=E.material;if(Array.isArray(B)){const V=F.groups;for(let k=0,Y=V.length;k<Y;k++){const W=V[k],ee=B[W.materialIndex];if(ee&&ee.visible){const $=v(E,ee,_,b);E.onBeforeShadow(r,E,w,C,F,$,W),r.renderBufferDirect(C,null,F,$,E,W),E.onAfterShadow(r,E,w,C,F,$,W)}}}else if(B.visible){const V=v(E,B,_,b);E.onBeforeShadow(r,E,w,C,F,V,null),r.renderBufferDirect(C,null,F,V,E,null),E.onAfterShadow(r,E,w,C,F,V,null)}}const N=E.children;for(let F=0,B=N.length;F<B;F++)S(N[F],w,C,_,b)}function A(E){E.target.removeEventListener("dispose",A);for(const C in c){const _=c[C],b=E.target.uuid;b in _&&(_[b].dispose(),delete _[b])}}}const zb={[ql]:jl,[Kl]:Ql,[Zl]:$l,[cr]:Jl,[jl]:ql,[Ql]:Kl,[$l]:Zl,[Jl]:cr};function kb(r,e){function t(){let L=!1;const le=new $e;let se=null;const re=new $e(0,0,0,0);return{setMask:function(te){se!==te&&!L&&(r.colorMask(te,te,te,te),se=te)},setLocked:function(te){L=te},setClear:function(te,K,pe,Ie,ht){ht===!0&&(te*=Ie,K*=Ie,pe*=Ie),le.set(te,K,pe,Ie),re.equals(le)===!1&&(r.clearColor(te,K,pe,Ie),re.copy(le))},reset:function(){L=!1,se=null,re.set(-1,0,0,0)}}}function n(){let L=!1,le=!1,se=null,re=null,te=null;return{setReversed:function(K){if(le!==K){const pe=e.get("EXT_clip_control");K?pe.clipControlEXT(pe.LOWER_LEFT_EXT,pe.ZERO_TO_ONE_EXT):pe.clipControlEXT(pe.LOWER_LEFT_EXT,pe.NEGATIVE_ONE_TO_ONE_EXT),le=K;const Ie=te;te=null,this.setClear(Ie)}},getReversed:function(){return le},setTest:function(K){K?J(r.DEPTH_TEST):fe(r.DEPTH_TEST)},setMask:function(K){se!==K&&!L&&(r.depthMask(K),se=K)},setFunc:function(K){if(le&&(K=zb[K]),re!==K){switch(K){case ql:r.depthFunc(r.NEVER);break;case jl:r.depthFunc(r.ALWAYS);break;case Kl:r.depthFunc(r.LESS);break;case cr:r.depthFunc(r.LEQUAL);break;case Zl:r.depthFunc(r.EQUAL);break;case Jl:r.depthFunc(r.GEQUAL);break;case Ql:r.depthFunc(r.GREATER);break;case $l:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}re=K}},setLocked:function(K){L=K},setClear:function(K){te!==K&&(le&&(K=1-K),r.clearDepth(K),te=K)},reset:function(){L=!1,se=null,re=null,te=null,le=!1}}}function i(){let L=!1,le=null,se=null,re=null,te=null,K=null,pe=null,Ie=null,ht=null;return{setTest:function(nt){L||(nt?J(r.STENCIL_TEST):fe(r.STENCIL_TEST))},setMask:function(nt){le!==nt&&!L&&(r.stencilMask(nt),le=nt)},setFunc:function(nt,Kn,Bn){(se!==nt||re!==Kn||te!==Bn)&&(r.stencilFunc(nt,Kn,Bn),se=nt,re=Kn,te=Bn)},setOp:function(nt,Kn,Bn){(K!==nt||pe!==Kn||Ie!==Bn)&&(r.stencilOp(nt,Kn,Bn),K=nt,pe=Kn,Ie=Bn)},setLocked:function(nt){L=nt},setClear:function(nt){ht!==nt&&(r.clearStencil(nt),ht=nt)},reset:function(){L=!1,le=null,se=null,re=null,te=null,K=null,pe=null,Ie=null,ht=null}}}const s=new t,a=new n,o=new i,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,f=[],g=null,x=!1,m=null,p=null,M=null,v=null,S=null,A=null,E=null,w=new ye(0,0,0),C=0,_=!1,b=null,P=null,N=null,F=null,B=null;const V=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,Y=0;const W=r.getParameter(r.VERSION);W.indexOf("WebGL")!==-1?(Y=parseFloat(/^WebGL (\d)/.exec(W)[1]),k=Y>=1):W.indexOf("OpenGL ES")!==-1&&(Y=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),k=Y>=2);let ee=null,$={};const ge=r.getParameter(r.SCISSOR_BOX),Te=r.getParameter(r.VIEWPORT),Fe=new $e().fromArray(ge),Ve=new $e().fromArray(Te);function Je(L,le,se,re){const te=new Uint8Array(4),K=r.createTexture();r.bindTexture(L,K),r.texParameteri(L,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(L,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let pe=0;pe<se;pe++)L===r.TEXTURE_3D||L===r.TEXTURE_2D_ARRAY?r.texImage3D(le,0,r.RGBA,1,1,re,0,r.RGBA,r.UNSIGNED_BYTE,te):r.texImage2D(le+pe,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,te);return K}const j={};j[r.TEXTURE_2D]=Je(r.TEXTURE_2D,r.TEXTURE_2D,1),j[r.TEXTURE_CUBE_MAP]=Je(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),j[r.TEXTURE_2D_ARRAY]=Je(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),j[r.TEXTURE_3D]=Je(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),J(r.DEPTH_TEST),a.setFunc(cr),Ye(!1),qe(Zh),J(r.CULL_FACE),ut(Xn);function J(L){h[L]!==!0&&(r.enable(L),h[L]=!0)}function fe(L){h[L]!==!1&&(r.disable(L),h[L]=!1)}function Ue(L,le){return u[L]!==le?(r.bindFramebuffer(L,le),u[L]=le,L===r.DRAW_FRAMEBUFFER&&(u[r.FRAMEBUFFER]=le),L===r.FRAMEBUFFER&&(u[r.DRAW_FRAMEBUFFER]=le),!0):!1}function Me(L,le){let se=f,re=!1;if(L){se=d.get(le),se===void 0&&(se=[],d.set(le,se));const te=L.textures;if(se.length!==te.length||se[0]!==r.COLOR_ATTACHMENT0){for(let K=0,pe=te.length;K<pe;K++)se[K]=r.COLOR_ATTACHMENT0+K;se.length=te.length,re=!0}}else se[0]!==r.BACK&&(se[0]=r.BACK,re=!0);re&&r.drawBuffers(se)}function Xe(L){return g!==L?(r.useProgram(L),g=L,!0):!1}const zt={[ms]:r.FUNC_ADD,[zp]:r.FUNC_SUBTRACT,[kp]:r.FUNC_REVERSE_SUBTRACT};zt[Vp]=r.MIN,zt[Hp]=r.MAX;const Ge={[Gp]:r.ZERO,[Wp]:r.ONE,[Xp]:r.SRC_COLOR,[Xl]:r.SRC_ALPHA,[Jp]:r.SRC_ALPHA_SATURATE,[Kp]:r.DST_COLOR,[qp]:r.DST_ALPHA,[Yp]:r.ONE_MINUS_SRC_COLOR,[Yl]:r.ONE_MINUS_SRC_ALPHA,[Zp]:r.ONE_MINUS_DST_COLOR,[jp]:r.ONE_MINUS_DST_ALPHA,[Qp]:r.CONSTANT_COLOR,[$p]:r.ONE_MINUS_CONSTANT_COLOR,[em]:r.CONSTANT_ALPHA,[tm]:r.ONE_MINUS_CONSTANT_ALPHA};function ut(L,le,se,re,te,K,pe,Ie,ht,nt){if(L===Xn){x===!0&&(fe(r.BLEND),x=!1);return}if(x===!1&&(J(r.BLEND),x=!0),L!==Bp){if(L!==m||nt!==_){if((p!==ms||S!==ms)&&(r.blendEquation(r.FUNC_ADD),p=ms,S=ms),nt)switch(L){case $s:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case xo:r.blendFunc(r.ONE,r.ONE);break;case Jh:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Qh:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:He("WebGLState: Invalid blending: ",L);break}else switch(L){case $s:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case xo:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case Jh:He("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Qh:He("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:He("WebGLState: Invalid blending: ",L);break}M=null,v=null,A=null,E=null,w.set(0,0,0),C=0,m=L,_=nt}return}te=te||le,K=K||se,pe=pe||re,(le!==p||te!==S)&&(r.blendEquationSeparate(zt[le],zt[te]),p=le,S=te),(se!==M||re!==v||K!==A||pe!==E)&&(r.blendFuncSeparate(Ge[se],Ge[re],Ge[K],Ge[pe]),M=se,v=re,A=K,E=pe),(Ie.equals(w)===!1||ht!==C)&&(r.blendColor(Ie.r,Ie.g,Ie.b,ht),w.copy(Ie),C=ht),m=L,_=!1}function D(L,le){L.side===$n?fe(r.CULL_FACE):J(r.CULL_FACE);let se=L.side===ln;le&&(se=!se),Ye(se),L.blending===$s&&L.transparent===!1?ut(Xn):ut(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),a.setFunc(L.depthFunc),a.setTest(L.depthTest),a.setMask(L.depthWrite),s.setMask(L.colorWrite);const re=L.stencilWrite;o.setTest(re),re&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),xe(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?J(r.SAMPLE_ALPHA_TO_COVERAGE):fe(r.SAMPLE_ALPHA_TO_COVERAGE)}function Ye(L){b!==L&&(L?r.frontFace(r.CW):r.frontFace(r.CCW),b=L)}function qe(L){L!==Up?(J(r.CULL_FACE),L!==P&&(L===Zh?r.cullFace(r.BACK):L===Fp?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):fe(r.CULL_FACE),P=L}function ct(L){L!==N&&(k&&r.lineWidth(L),N=L)}function xe(L,le,se){L?(J(r.POLYGON_OFFSET_FILL),(F!==le||B!==se)&&(r.polygonOffset(le,se),F=le,B=se)):fe(r.POLYGON_OFFSET_FILL)}function pt(L){L?J(r.SCISSOR_TEST):fe(r.SCISSOR_TEST)}function Ee(L){L===void 0&&(L=r.TEXTURE0+V-1),ee!==L&&(r.activeTexture(L),ee=L)}function Ne(L,le,se){se===void 0&&(ee===null?se=r.TEXTURE0+V-1:se=ee);let re=$[se];re===void 0&&(re={type:void 0,texture:void 0},$[se]=re),(re.type!==L||re.texture!==le)&&(ee!==se&&(r.activeTexture(se),ee=se),r.bindTexture(L,le||j[L]),re.type=L,re.texture=le)}function R(){const L=$[ee];L!==void 0&&L.type!==void 0&&(r.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function y(){try{r.compressedTexImage2D(...arguments)}catch(L){L("WebGLState:",L)}}function z(){try{r.compressedTexImage3D(...arguments)}catch(L){L("WebGLState:",L)}}function q(){try{r.texSubImage2D(...arguments)}catch(L){L("WebGLState:",L)}}function Z(){try{r.texSubImage3D(...arguments)}catch(L){L("WebGLState:",L)}}function X(){try{r.compressedTexSubImage2D(...arguments)}catch(L){L("WebGLState:",L)}}function be(){try{r.compressedTexSubImage3D(...arguments)}catch(L){L("WebGLState:",L)}}function oe(){try{r.texStorage2D(...arguments)}catch(L){L("WebGLState:",L)}}function Ae(){try{r.texStorage3D(...arguments)}catch(L){L("WebGLState:",L)}}function _e(){try{r.texImage2D(...arguments)}catch(L){L("WebGLState:",L)}}function Q(){try{r.texImage3D(...arguments)}catch(L){L("WebGLState:",L)}}function ie(L){Fe.equals(L)===!1&&(r.scissor(L.x,L.y,L.z,L.w),Fe.copy(L))}function Pe(L){Ve.equals(L)===!1&&(r.viewport(L.x,L.y,L.z,L.w),Ve.copy(L))}function Re(L,le){let se=c.get(le);se===void 0&&(se=new WeakMap,c.set(le,se));let re=se.get(L);re===void 0&&(re=r.getUniformBlockIndex(le,L.name),se.set(L,re))}function he(L,le){const re=c.get(le).get(L);l.get(le)!==re&&(r.uniformBlockBinding(le,re,L.__bindingPointIndex),l.set(le,re))}function Le(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),a.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),h={},ee=null,$={},u={},d=new WeakMap,f=[],g=null,x=!1,m=null,p=null,M=null,v=null,S=null,A=null,E=null,w=new ye(0,0,0),C=0,_=!1,b=null,P=null,N=null,F=null,B=null,Fe.set(0,0,r.canvas.width,r.canvas.height),Ve.set(0,0,r.canvas.width,r.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:J,disable:fe,bindFramebuffer:Ue,drawBuffers:Me,useProgram:Xe,setBlending:ut,setMaterial:D,setFlipSided:Ye,setCullFace:qe,setLineWidth:ct,setPolygonOffset:xe,setScissorTest:pt,activeTexture:Ee,bindTexture:Ne,unbindTexture:R,compressedTexImage2D:y,compressedTexImage3D:z,texImage2D:_e,texImage3D:Q,updateUBOMapping:Re,uniformBlockBinding:he,texStorage2D:oe,texStorage3D:Ae,texSubImage2D:q,texSubImage3D:Z,compressedTexSubImage2D:X,compressedTexSubImage3D:be,scissor:ie,viewport:Pe,reset:Le}}function Vb(r,e,t,n,i,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ue,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(R,y){return f?new OffscreenCanvas(R,y):aa("canvas")}function x(R,y,z){let q=1;const Z=Ne(R);if((Z.width>z||Z.height>z)&&(q=z/Math.max(Z.width,Z.height)),q<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){const X=Math.floor(q*Z.width),be=Math.floor(q*Z.height);u===void 0&&(u=g(X,be));const oe=y?g(X,be):u;return oe.width=X,oe.height=be,oe.getContext("2d").drawImage(R,0,0,X,be),ve("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+X+"x"+be+")."),oe}else return"data"in R&&ve("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),R;return R}function m(R){return R.generateMipmaps}function p(R){r.generateMipmap(R)}function M(R){return R.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?r.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function v(R,y,z,q,Z=!1){if(R!==null){if(r[R]!==void 0)return r[R];ve("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let X=y;if(y===r.RED&&(z===r.FLOAT&&(X=r.R32F),z===r.HALF_FLOAT&&(X=r.R16F),z===r.UNSIGNED_BYTE&&(X=r.R8)),y===r.RED_INTEGER&&(z===r.UNSIGNED_BYTE&&(X=r.R8UI),z===r.UNSIGNED_SHORT&&(X=r.R16UI),z===r.UNSIGNED_INT&&(X=r.R32UI),z===r.BYTE&&(X=r.R8I),z===r.SHORT&&(X=r.R16I),z===r.INT&&(X=r.R32I)),y===r.RG&&(z===r.FLOAT&&(X=r.RG32F),z===r.HALF_FLOAT&&(X=r.RG16F),z===r.UNSIGNED_BYTE&&(X=r.RG8)),y===r.RG_INTEGER&&(z===r.UNSIGNED_BYTE&&(X=r.RG8UI),z===r.UNSIGNED_SHORT&&(X=r.RG16UI),z===r.UNSIGNED_INT&&(X=r.RG32UI),z===r.BYTE&&(X=r.RG8I),z===r.SHORT&&(X=r.RG16I),z===r.INT&&(X=r.RG32I)),y===r.RGB_INTEGER&&(z===r.UNSIGNED_BYTE&&(X=r.RGB8UI),z===r.UNSIGNED_SHORT&&(X=r.RGB16UI),z===r.UNSIGNED_INT&&(X=r.RGB32UI),z===r.BYTE&&(X=r.RGB8I),z===r.SHORT&&(X=r.RGB16I),z===r.INT&&(X=r.RGB32I)),y===r.RGBA_INTEGER&&(z===r.UNSIGNED_BYTE&&(X=r.RGBA8UI),z===r.UNSIGNED_SHORT&&(X=r.RGBA16UI),z===r.UNSIGNED_INT&&(X=r.RGBA32UI),z===r.BYTE&&(X=r.RGBA8I),z===r.SHORT&&(X=r.RGBA16I),z===r.INT&&(X=r.RGBA32I)),y===r.RGB&&(z===r.UNSIGNED_INT_5_9_9_9_REV&&(X=r.RGB9_E5),z===r.UNSIGNED_INT_10F_11F_11F_REV&&(X=r.R11F_G11F_B10F)),y===r.RGBA){const be=Z?bo:Ke.getTransfer(q);z===r.FLOAT&&(X=r.RGBA32F),z===r.HALF_FLOAT&&(X=r.RGBA16F),z===r.UNSIGNED_BYTE&&(X=be===st?r.SRGB8_ALPHA8:r.RGBA8),z===r.UNSIGNED_SHORT_4_4_4_4&&(X=r.RGBA4),z===r.UNSIGNED_SHORT_5_5_5_1&&(X=r.RGB5_A1)}return(X===r.R16F||X===r.R32F||X===r.RG16F||X===r.RG32F||X===r.RGBA16F||X===r.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function S(R,y){let z;return R?y===null||y===Ts||y===ta?z=r.DEPTH24_STENCIL8:y===tn?z=r.DEPTH32F_STENCIL8:y===ea&&(z=r.DEPTH24_STENCIL8,ve("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===Ts||y===ta?z=r.DEPTH_COMPONENT24:y===tn?z=r.DEPTH_COMPONENT32F:y===ea&&(z=r.DEPTH_COMPONENT16),z}function A(R,y){return m(R)===!0||R.isFramebufferTexture&&R.minFilter!==bt&&R.minFilter!==At?Math.log2(Math.max(y.width,y.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?y.mipmaps.length:1}function E(R){const y=R.target;y.removeEventListener("dispose",E),C(y),y.isVideoTexture&&h.delete(y)}function w(R){const y=R.target;y.removeEventListener("dispose",w),b(y)}function C(R){const y=n.get(R);if(y.__webglInit===void 0)return;const z=R.source,q=d.get(z);if(q){const Z=q[y.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&_(R),Object.keys(q).length===0&&d.delete(z)}n.remove(R)}function _(R){const y=n.get(R);r.deleteTexture(y.__webglTexture);const z=R.source,q=d.get(z);delete q[y.__cacheKey],a.memory.textures--}function b(R){const y=n.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),n.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(y.__webglFramebuffer[q]))for(let Z=0;Z<y.__webglFramebuffer[q].length;Z++)r.deleteFramebuffer(y.__webglFramebuffer[q][Z]);else r.deleteFramebuffer(y.__webglFramebuffer[q]);y.__webglDepthbuffer&&r.deleteRenderbuffer(y.__webglDepthbuffer[q])}else{if(Array.isArray(y.__webglFramebuffer))for(let q=0;q<y.__webglFramebuffer.length;q++)r.deleteFramebuffer(y.__webglFramebuffer[q]);else r.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&r.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&r.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let q=0;q<y.__webglColorRenderbuffer.length;q++)y.__webglColorRenderbuffer[q]&&r.deleteRenderbuffer(y.__webglColorRenderbuffer[q]);y.__webglDepthRenderbuffer&&r.deleteRenderbuffer(y.__webglDepthRenderbuffer)}const z=R.textures;for(let q=0,Z=z.length;q<Z;q++){const X=n.get(z[q]);X.__webglTexture&&(r.deleteTexture(X.__webglTexture),a.memory.textures--),n.remove(z[q])}n.remove(R)}let P=0;function N(){P=0}function F(){const R=P;return R>=i.maxTextures&&ve("WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+i.maxTextures),P+=1,R}function B(R){const y=[];return y.push(R.wrapS),y.push(R.wrapT),y.push(R.wrapR||0),y.push(R.magFilter),y.push(R.minFilter),y.push(R.anisotropy),y.push(R.internalFormat),y.push(R.format),y.push(R.type),y.push(R.generateMipmaps),y.push(R.premultiplyAlpha),y.push(R.flipY),y.push(R.unpackAlignment),y.push(R.colorSpace),y.join()}function V(R,y){const z=n.get(R);if(R.isVideoTexture&&pt(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&z.__version!==R.version){const q=R.image;if(q===null)ve("WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)ve("WebGLRenderer: Texture marked for update but image is incomplete");else{j(z,R,y);return}}else R.isExternalTexture&&(z.__webglTexture=R.sourceTexture?R.sourceTexture:null);t.bindTexture(r.TEXTURE_2D,z.__webglTexture,r.TEXTURE0+y)}function k(R,y){const z=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&z.__version!==R.version){j(z,R,y);return}else R.isExternalTexture&&(z.__webglTexture=R.sourceTexture?R.sourceTexture:null);t.bindTexture(r.TEXTURE_2D_ARRAY,z.__webglTexture,r.TEXTURE0+y)}function Y(R,y){const z=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&z.__version!==R.version){j(z,R,y);return}t.bindTexture(r.TEXTURE_3D,z.__webglTexture,r.TEXTURE0+y)}function W(R,y){const z=n.get(R);if(R.version>0&&z.__version!==R.version){J(z,R,y);return}t.bindTexture(r.TEXTURE_CUBE_MAP,z.__webglTexture,r.TEXTURE0+y)}const ee={[dr]:r.REPEAT,[Ln]:r.CLAMP_TO_EDGE,[_o]:r.MIRRORED_REPEAT},$={[bt]:r.NEAREST,[Yd]:r.NEAREST_MIPMAP_NEAREST,[Wr]:r.NEAREST_MIPMAP_LINEAR,[At]:r.LINEAR,[ao]:r.LINEAR_MIPMAP_NEAREST,[ti]:r.LINEAR_MIPMAP_LINEAR},ge={[vm]:r.NEVER,[Em]:r.ALWAYS,[bm]:r.LESS,[ef]:r.LEQUAL,[ym]:r.EQUAL,[Tm]:r.GEQUAL,[Mm]:r.GREATER,[Sm]:r.NOTEQUAL};function Te(R,y){if(y.type===tn&&e.has("OES_texture_float_linear")===!1&&(y.magFilter===At||y.magFilter===ao||y.magFilter===Wr||y.magFilter===ti||y.minFilter===At||y.minFilter===ao||y.minFilter===Wr||y.minFilter===ti)&&ve("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(R,r.TEXTURE_WRAP_S,ee[y.wrapS]),r.texParameteri(R,r.TEXTURE_WRAP_T,ee[y.wrapT]),(R===r.TEXTURE_3D||R===r.TEXTURE_2D_ARRAY)&&r.texParameteri(R,r.TEXTURE_WRAP_R,ee[y.wrapR]),r.texParameteri(R,r.TEXTURE_MAG_FILTER,$[y.magFilter]),r.texParameteri(R,r.TEXTURE_MIN_FILTER,$[y.minFilter]),y.compareFunction&&(r.texParameteri(R,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(R,r.TEXTURE_COMPARE_FUNC,ge[y.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===bt||y.minFilter!==Wr&&y.minFilter!==ti||y.type===tn&&e.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||n.get(y).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");r.texParameterf(R,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,i.getMaxAnisotropy())),n.get(y).__currentAnisotropy=y.anisotropy}}}function Fe(R,y){let z=!1;R.__webglInit===void 0&&(R.__webglInit=!0,y.addEventListener("dispose",E));const q=y.source;let Z=d.get(q);Z===void 0&&(Z={},d.set(q,Z));const X=B(y);if(X!==R.__cacheKey){Z[X]===void 0&&(Z[X]={texture:r.createTexture(),usedTimes:0},a.memory.textures++,z=!0),Z[X].usedTimes++;const be=Z[R.__cacheKey];be!==void 0&&(Z[R.__cacheKey].usedTimes--,be.usedTimes===0&&_(y)),R.__cacheKey=X,R.__webglTexture=Z[X].texture}return z}function Ve(R,y,z){return Math.floor(Math.floor(R/z)/y)}function Je(R,y,z,q){const X=R.updateRanges;if(X.length===0)t.texSubImage2D(r.TEXTURE_2D,0,0,0,y.width,y.height,z,q,y.data);else{X.sort((Q,ie)=>Q.start-ie.start);let be=0;for(let Q=1;Q<X.length;Q++){const ie=X[be],Pe=X[Q],Re=ie.start+ie.count,he=Ve(Pe.start,y.width,4),Le=Ve(ie.start,y.width,4);Pe.start<=Re+1&&he===Le&&Ve(Pe.start+Pe.count-1,y.width,4)===he?ie.count=Math.max(ie.count,Pe.start+Pe.count-ie.start):(++be,X[be]=Pe)}X.length=be+1;const oe=r.getParameter(r.UNPACK_ROW_LENGTH),Ae=r.getParameter(r.UNPACK_SKIP_PIXELS),_e=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,y.width);for(let Q=0,ie=X.length;Q<ie;Q++){const Pe=X[Q],Re=Math.floor(Pe.start/4),he=Math.ceil(Pe.count/4),Le=Re%y.width,L=Math.floor(Re/y.width),le=he,se=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,Le),r.pixelStorei(r.UNPACK_SKIP_ROWS,L),t.texSubImage2D(r.TEXTURE_2D,0,Le,L,le,se,z,q,y.data)}R.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,oe),r.pixelStorei(r.UNPACK_SKIP_PIXELS,Ae),r.pixelStorei(r.UNPACK_SKIP_ROWS,_e)}}function j(R,y,z){let q=r.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(q=r.TEXTURE_2D_ARRAY),y.isData3DTexture&&(q=r.TEXTURE_3D);const Z=Fe(R,y),X=y.source;t.bindTexture(q,R.__webglTexture,r.TEXTURE0+z);const be=n.get(X);if(X.version!==be.__version||Z===!0){t.activeTexture(r.TEXTURE0+z);const oe=Ke.getPrimaries(Ke.workingColorSpace),Ae=y.colorSpace===Hi?null:Ke.getPrimaries(y.colorSpace),_e=y.colorSpace===Hi||oe===Ae?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,y.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,y.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,_e);let Q=x(y.image,!1,i.maxTextureSize);Q=Ee(y,Q);const ie=s.convert(y.format,y.colorSpace),Pe=s.convert(y.type);let Re=v(y.internalFormat,ie,Pe,y.colorSpace,y.isVideoTexture);Te(q,y);let he;const Le=y.mipmaps,L=y.isVideoTexture!==!0,le=be.__version===void 0||Z===!0,se=X.dataReady,re=A(y,Q);if(y.isDepthTexture)Re=S(y.format===ia,y.type),le&&(L?t.texStorage2D(r.TEXTURE_2D,1,Re,Q.width,Q.height):t.texImage2D(r.TEXTURE_2D,0,Re,Q.width,Q.height,0,ie,Pe,null));else if(y.isDataTexture)if(Le.length>0){L&&le&&t.texStorage2D(r.TEXTURE_2D,re,Re,Le[0].width,Le[0].height);for(let te=0,K=Le.length;te<K;te++)he=Le[te],L?se&&t.texSubImage2D(r.TEXTURE_2D,te,0,0,he.width,he.height,ie,Pe,he.data):t.texImage2D(r.TEXTURE_2D,te,Re,he.width,he.height,0,ie,Pe,he.data);y.generateMipmaps=!1}else L?(le&&t.texStorage2D(r.TEXTURE_2D,re,Re,Q.width,Q.height),se&&Je(y,Q,ie,Pe)):t.texImage2D(r.TEXTURE_2D,0,Re,Q.width,Q.height,0,ie,Pe,Q.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){L&&le&&t.texStorage3D(r.TEXTURE_2D_ARRAY,re,Re,Le[0].width,Le[0].height,Q.depth);for(let te=0,K=Le.length;te<K;te++)if(he=Le[te],y.format!==In)if(ie!==null)if(L){if(se)if(y.layerUpdates.size>0){const pe=Gu(he.width,he.height,y.format,y.type);for(const Ie of y.layerUpdates){const ht=he.data.subarray(Ie*pe/he.data.BYTES_PER_ELEMENT,(Ie+1)*pe/he.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,te,0,0,Ie,he.width,he.height,1,ie,ht)}y.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,te,0,0,0,he.width,he.height,Q.depth,ie,he.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,te,Re,he.width,he.height,Q.depth,0,he.data,0,0);else ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else L?se&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,te,0,0,0,he.width,he.height,Q.depth,ie,Pe,he.data):t.texImage3D(r.TEXTURE_2D_ARRAY,te,Re,he.width,he.height,Q.depth,0,ie,Pe,he.data)}else{L&&le&&t.texStorage2D(r.TEXTURE_2D,re,Re,Le[0].width,Le[0].height);for(let te=0,K=Le.length;te<K;te++)he=Le[te],y.format!==In?ie!==null?L?se&&t.compressedTexSubImage2D(r.TEXTURE_2D,te,0,0,he.width,he.height,ie,he.data):t.compressedTexImage2D(r.TEXTURE_2D,te,Re,he.width,he.height,0,he.data):ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?se&&t.texSubImage2D(r.TEXTURE_2D,te,0,0,he.width,he.height,ie,Pe,he.data):t.texImage2D(r.TEXTURE_2D,te,Re,he.width,he.height,0,ie,Pe,he.data)}else if(y.isDataArrayTexture)if(L){if(le&&t.texStorage3D(r.TEXTURE_2D_ARRAY,re,Re,Q.width,Q.height,Q.depth),se)if(y.layerUpdates.size>0){const te=Gu(Q.width,Q.height,y.format,y.type);for(const K of y.layerUpdates){const pe=Q.data.subarray(K*te/Q.data.BYTES_PER_ELEMENT,(K+1)*te/Q.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,K,Q.width,Q.height,1,ie,Pe,pe)}y.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ie,Pe,Q.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,Re,Q.width,Q.height,Q.depth,0,ie,Pe,Q.data);else if(y.isData3DTexture)L?(le&&t.texStorage3D(r.TEXTURE_3D,re,Re,Q.width,Q.height,Q.depth),se&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ie,Pe,Q.data)):t.texImage3D(r.TEXTURE_3D,0,Re,Q.width,Q.height,Q.depth,0,ie,Pe,Q.data);else if(y.isFramebufferTexture){if(le)if(L)t.texStorage2D(r.TEXTURE_2D,re,Re,Q.width,Q.height);else{let te=Q.width,K=Q.height;for(let pe=0;pe<re;pe++)t.texImage2D(r.TEXTURE_2D,pe,Re,te,K,0,ie,Pe,null),te>>=1,K>>=1}}else if(Le.length>0){if(L&&le){const te=Ne(Le[0]);t.texStorage2D(r.TEXTURE_2D,re,Re,te.width,te.height)}for(let te=0,K=Le.length;te<K;te++)he=Le[te],L?se&&t.texSubImage2D(r.TEXTURE_2D,te,0,0,ie,Pe,he):t.texImage2D(r.TEXTURE_2D,te,Re,ie,Pe,he);y.generateMipmaps=!1}else if(L){if(le){const te=Ne(Q);t.texStorage2D(r.TEXTURE_2D,re,Re,te.width,te.height)}se&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,ie,Pe,Q)}else t.texImage2D(r.TEXTURE_2D,0,Re,ie,Pe,Q);m(y)&&p(q),be.__version=X.version,y.onUpdate&&y.onUpdate(y)}R.__version=y.version}function J(R,y,z){if(y.image.length!==6)return;const q=Fe(R,y),Z=y.source;t.bindTexture(r.TEXTURE_CUBE_MAP,R.__webglTexture,r.TEXTURE0+z);const X=n.get(Z);if(Z.version!==X.__version||q===!0){t.activeTexture(r.TEXTURE0+z);const be=Ke.getPrimaries(Ke.workingColorSpace),oe=y.colorSpace===Hi?null:Ke.getPrimaries(y.colorSpace),Ae=y.colorSpace===Hi||be===oe?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,y.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,y.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ae);const _e=y.isCompressedTexture||y.image[0].isCompressedTexture,Q=y.image[0]&&y.image[0].isDataTexture,ie=[];for(let K=0;K<6;K++)!_e&&!Q?ie[K]=x(y.image[K],!0,i.maxCubemapSize):ie[K]=Q?y.image[K].image:y.image[K],ie[K]=Ee(y,ie[K]);const Pe=ie[0],Re=s.convert(y.format,y.colorSpace),he=s.convert(y.type),Le=v(y.internalFormat,Re,he,y.colorSpace),L=y.isVideoTexture!==!0,le=X.__version===void 0||q===!0,se=Z.dataReady;let re=A(y,Pe);Te(r.TEXTURE_CUBE_MAP,y);let te;if(_e){L&&le&&t.texStorage2D(r.TEXTURE_CUBE_MAP,re,Le,Pe.width,Pe.height);for(let K=0;K<6;K++){te=ie[K].mipmaps;for(let pe=0;pe<te.length;pe++){const Ie=te[pe];y.format!==In?Re!==null?L?se&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,pe,0,0,Ie.width,Ie.height,Re,Ie.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,pe,Le,Ie.width,Ie.height,0,Ie.data):ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?se&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,pe,0,0,Ie.width,Ie.height,Re,he,Ie.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,pe,Le,Ie.width,Ie.height,0,Re,he,Ie.data)}}}else{if(te=y.mipmaps,L&&le){te.length>0&&re++;const K=Ne(ie[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,re,Le,K.width,K.height)}for(let K=0;K<6;K++)if(Q){L?se&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,ie[K].width,ie[K].height,Re,he,ie[K].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Le,ie[K].width,ie[K].height,0,Re,he,ie[K].data);for(let pe=0;pe<te.length;pe++){const ht=te[pe].image[K].image;L?se&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,pe+1,0,0,ht.width,ht.height,Re,he,ht.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,pe+1,Le,ht.width,ht.height,0,Re,he,ht.data)}}else{L?se&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Re,he,ie[K]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Le,Re,he,ie[K]);for(let pe=0;pe<te.length;pe++){const Ie=te[pe];L?se&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,pe+1,0,0,Re,he,Ie.image[K]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,pe+1,Le,Re,he,Ie.image[K])}}}m(y)&&p(r.TEXTURE_CUBE_MAP),X.__version=Z.version,y.onUpdate&&y.onUpdate(y)}R.__version=y.version}function fe(R,y,z,q,Z,X){const be=s.convert(z.format,z.colorSpace),oe=s.convert(z.type),Ae=v(z.internalFormat,be,oe,z.colorSpace),_e=n.get(y),Q=n.get(z);if(Q.__renderTarget=y,!_e.__hasExternalTextures){const ie=Math.max(1,y.width>>X),Pe=Math.max(1,y.height>>X);Z===r.TEXTURE_3D||Z===r.TEXTURE_2D_ARRAY?t.texImage3D(Z,X,Ae,ie,Pe,y.depth,0,be,oe,null):t.texImage2D(Z,X,Ae,ie,Pe,0,be,oe,null)}t.bindFramebuffer(r.FRAMEBUFFER,R),xe(y)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,q,Z,Q.__webglTexture,0,ct(y)):(Z===r.TEXTURE_2D||Z>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,q,Z,Q.__webglTexture,X),t.bindFramebuffer(r.FRAMEBUFFER,null)}function Ue(R,y,z){if(r.bindRenderbuffer(r.RENDERBUFFER,R),y.depthBuffer){const q=y.depthTexture,Z=q&&q.isDepthTexture?q.type:null,X=S(y.stencilBuffer,Z),be=y.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,oe=ct(y);xe(y)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,oe,X,y.width,y.height):z?r.renderbufferStorageMultisample(r.RENDERBUFFER,oe,X,y.width,y.height):r.renderbufferStorage(r.RENDERBUFFER,X,y.width,y.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,be,r.RENDERBUFFER,R)}else{const q=y.textures;for(let Z=0;Z<q.length;Z++){const X=q[Z],be=s.convert(X.format,X.colorSpace),oe=s.convert(X.type),Ae=v(X.internalFormat,be,oe,X.colorSpace),_e=ct(y);z&&xe(y)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,_e,Ae,y.width,y.height):xe(y)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,_e,Ae,y.width,y.height):r.renderbufferStorage(r.RENDERBUFFER,Ae,y.width,y.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function Me(R,y){if(y&&y.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,R),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const q=n.get(y.depthTexture);q.__renderTarget=y,(!q.__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),V(y.depthTexture,0);const Z=q.__webglTexture,X=ct(y);if(y.depthTexture.format===na)xe(y)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,Z,0,X):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,Z,0);else if(y.depthTexture.format===ia)xe(y)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,Z,0,X):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function Xe(R){const y=n.get(R),z=R.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==R.depthTexture){const q=R.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),q){const Z=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,q.removeEventListener("dispose",Z)};q.addEventListener("dispose",Z),y.__depthDisposeCallback=Z}y.__boundDepthTexture=q}if(R.depthTexture&&!y.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");const q=R.texture.mipmaps;q&&q.length>0?Me(y.__webglFramebuffer[0],R):Me(y.__webglFramebuffer,R)}else if(z){y.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(t.bindFramebuffer(r.FRAMEBUFFER,y.__webglFramebuffer[q]),y.__webglDepthbuffer[q]===void 0)y.__webglDepthbuffer[q]=r.createRenderbuffer(),Ue(y.__webglDepthbuffer[q],R,!1);else{const Z=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,X=y.__webglDepthbuffer[q];r.bindRenderbuffer(r.RENDERBUFFER,X),r.framebufferRenderbuffer(r.FRAMEBUFFER,Z,r.RENDERBUFFER,X)}}else{const q=R.texture.mipmaps;if(q&&q.length>0?t.bindFramebuffer(r.FRAMEBUFFER,y.__webglFramebuffer[0]):t.bindFramebuffer(r.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=r.createRenderbuffer(),Ue(y.__webglDepthbuffer,R,!1);else{const Z=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,X=y.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,X),r.framebufferRenderbuffer(r.FRAMEBUFFER,Z,r.RENDERBUFFER,X)}}t.bindFramebuffer(r.FRAMEBUFFER,null)}function zt(R,y,z){const q=n.get(R);y!==void 0&&fe(q.__webglFramebuffer,R,R.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),z!==void 0&&Xe(R)}function Ge(R){const y=R.texture,z=n.get(R),q=n.get(y);R.addEventListener("dispose",w);const Z=R.textures,X=R.isWebGLCubeRenderTarget===!0,be=Z.length>1;if(be||(q.__webglTexture===void 0&&(q.__webglTexture=r.createTexture()),q.__version=y.version,a.memory.textures++),X){z.__webglFramebuffer=[];for(let oe=0;oe<6;oe++)if(y.mipmaps&&y.mipmaps.length>0){z.__webglFramebuffer[oe]=[];for(let Ae=0;Ae<y.mipmaps.length;Ae++)z.__webglFramebuffer[oe][Ae]=r.createFramebuffer()}else z.__webglFramebuffer[oe]=r.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){z.__webglFramebuffer=[];for(let oe=0;oe<y.mipmaps.length;oe++)z.__webglFramebuffer[oe]=r.createFramebuffer()}else z.__webglFramebuffer=r.createFramebuffer();if(be)for(let oe=0,Ae=Z.length;oe<Ae;oe++){const _e=n.get(Z[oe]);_e.__webglTexture===void 0&&(_e.__webglTexture=r.createTexture(),a.memory.textures++)}if(R.samples>0&&xe(R)===!1){z.__webglMultisampledFramebuffer=r.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let oe=0;oe<Z.length;oe++){const Ae=Z[oe];z.__webglColorRenderbuffer[oe]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,z.__webglColorRenderbuffer[oe]);const _e=s.convert(Ae.format,Ae.colorSpace),Q=s.convert(Ae.type),ie=v(Ae.internalFormat,_e,Q,Ae.colorSpace,R.isXRRenderTarget===!0),Pe=ct(R);r.renderbufferStorageMultisample(r.RENDERBUFFER,Pe,ie,R.width,R.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+oe,r.RENDERBUFFER,z.__webglColorRenderbuffer[oe])}r.bindRenderbuffer(r.RENDERBUFFER,null),R.depthBuffer&&(z.__webglDepthRenderbuffer=r.createRenderbuffer(),Ue(z.__webglDepthRenderbuffer,R,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(X){t.bindTexture(r.TEXTURE_CUBE_MAP,q.__webglTexture),Te(r.TEXTURE_CUBE_MAP,y);for(let oe=0;oe<6;oe++)if(y.mipmaps&&y.mipmaps.length>0)for(let Ae=0;Ae<y.mipmaps.length;Ae++)fe(z.__webglFramebuffer[oe][Ae],R,y,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Ae);else fe(z.__webglFramebuffer[oe],R,y,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0);m(y)&&p(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(be){for(let oe=0,Ae=Z.length;oe<Ae;oe++){const _e=Z[oe],Q=n.get(_e);let ie=r.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(ie=R.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(ie,Q.__webglTexture),Te(ie,_e),fe(z.__webglFramebuffer,R,_e,r.COLOR_ATTACHMENT0+oe,ie,0),m(_e)&&p(ie)}t.unbindTexture()}else{let oe=r.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(oe=R.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(oe,q.__webglTexture),Te(oe,y),y.mipmaps&&y.mipmaps.length>0)for(let Ae=0;Ae<y.mipmaps.length;Ae++)fe(z.__webglFramebuffer[Ae],R,y,r.COLOR_ATTACHMENT0,oe,Ae);else fe(z.__webglFramebuffer,R,y,r.COLOR_ATTACHMENT0,oe,0);m(y)&&p(oe),t.unbindTexture()}R.depthBuffer&&Xe(R)}function ut(R){const y=R.textures;for(let z=0,q=y.length;z<q;z++){const Z=y[z];if(m(Z)){const X=M(R),be=n.get(Z).__webglTexture;t.bindTexture(X,be),p(X),t.unbindTexture()}}}const D=[],Ye=[];function qe(R){if(R.samples>0){if(xe(R)===!1){const y=R.textures,z=R.width,q=R.height;let Z=r.COLOR_BUFFER_BIT;const X=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,be=n.get(R),oe=y.length>1;if(oe)for(let _e=0;_e<y.length;_e++)t.bindFramebuffer(r.FRAMEBUFFER,be.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+_e,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,be.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+_e,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,be.__webglMultisampledFramebuffer);const Ae=R.texture.mipmaps;Ae&&Ae.length>0?t.bindFramebuffer(r.DRAW_FRAMEBUFFER,be.__webglFramebuffer[0]):t.bindFramebuffer(r.DRAW_FRAMEBUFFER,be.__webglFramebuffer);for(let _e=0;_e<y.length;_e++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(Z|=r.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(Z|=r.STENCIL_BUFFER_BIT)),oe){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,be.__webglColorRenderbuffer[_e]);const Q=n.get(y[_e]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Q,0)}r.blitFramebuffer(0,0,z,q,0,0,z,q,Z,r.NEAREST),l===!0&&(D.length=0,Ye.length=0,D.push(r.COLOR_ATTACHMENT0+_e),R.depthBuffer&&R.resolveDepthBuffer===!1&&(D.push(X),Ye.push(X),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Ye)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,D))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),oe)for(let _e=0;_e<y.length;_e++){t.bindFramebuffer(r.FRAMEBUFFER,be.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+_e,r.RENDERBUFFER,be.__webglColorRenderbuffer[_e]);const Q=n.get(y[_e]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,be.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+_e,r.TEXTURE_2D,Q,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,be.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&l){const y=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[y])}}}function ct(R){return Math.min(i.maxSamples,R.samples)}function xe(R){const y=n.get(R);return R.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function pt(R){const y=a.render.frame;h.get(R)!==y&&(h.set(R,y),R.update())}function Ee(R,y){const z=R.colorSpace,q=R.format,Z=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||z!==Wt&&z!==Hi&&(Ke.getTransfer(z)===st?(q!==In||Z!==oi)&&ve("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):He("WebGLTextures: Unsupported texture color space:",z)),y}function Ne(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(c.width=R.naturalWidth||R.width,c.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(c.width=R.displayWidth,c.height=R.displayHeight):(c.width=R.width,c.height=R.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=N,this.setTexture2D=V,this.setTexture2DArray=k,this.setTexture3D=Y,this.setTextureCube=W,this.rebindTextures=zt,this.setupRenderTarget=Ge,this.updateRenderTargetMipmap=ut,this.updateMultisampleRenderTarget=qe,this.setupDepthRenderbuffer=Xe,this.setupFrameBufferTexture=fe,this.useMultisampledRTT=xe}function Hb(r,e){function t(n,i=Hi){let s;const a=Ke.getTransfer(i);if(n===oi)return r.UNSIGNED_BYTE;if(n===nh)return r.UNSIGNED_SHORT_4_4_4_4;if(n===ih)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Kd)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===Zd)return r.UNSIGNED_INT_10F_11F_11F_REV;if(n===qd)return r.BYTE;if(n===jd)return r.SHORT;if(n===ea)return r.UNSIGNED_SHORT;if(n===th)return r.INT;if(n===Ts)return r.UNSIGNED_INT;if(n===tn)return r.FLOAT;if(n===Dt)return r.HALF_FLOAT;if(n===Jd)return r.ALPHA;if(n===Qd)return r.RGB;if(n===In)return r.RGBA;if(n===na)return r.DEPTH_COMPONENT;if(n===ia)return r.DEPTH_STENCIL;if(n===No)return r.RED;if(n===sh)return r.RED_INTEGER;if(n===rh)return r.RG;if(n===ah)return r.RG_INTEGER;if(n===oh)return r.RGBA_INTEGER;if(n===oo||n===lo||n===co||n===ho)if(a===st)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===oo)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===lo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===co)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ho)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===oo)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===lo)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===co)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ho)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===tc||n===nc||n===ic||n===sc)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===tc)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===nc)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ic)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===sc)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===rc||n===ac||n===oc)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===rc||n===ac)return a===st?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===oc)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===lc||n===cc||n===hc||n===uc||n===dc||n===fc||n===pc||n===mc||n===xc||n===gc||n===_c||n===vc||n===bc||n===yc)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===lc)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===cc)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===hc)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===uc)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===dc)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===fc)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===pc)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===mc)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===xc)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===gc)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===_c)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===vc)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===bc)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===yc)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Mc||n===Sc||n===Tc)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Mc)return a===st?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Sc)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Tc)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ec||n===Ac||n===wc||n===Rc)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Ec)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Ac)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===wc)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Rc)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ta?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}const Gb=`
void main() {
