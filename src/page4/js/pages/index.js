...
export default class Index {
  constructor() {
    ...
    this.sources = [
      {
        type: "model",
        src: `${import.meta.env.VITE_MODEL_PATH_PREFIX}/model/cat4.glb`,
        detail:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page4/image-1.PNG",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page4/image-2.jpg",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page4/image-3.JPG",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page4/image-4.JPG",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page4/image-5.JPG",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page4/image-6.JPG",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page4/video-1.mov",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page4/video-2.mov",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page4/video-3.mp4",
        caption:
          "Production Fun Fact (Eggs) <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2024",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page4/image-7.JPG",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page4/image-8.JPG",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page4/image-9.JPG",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "/static/img/page4/video-4.mp4",
        caption:
          "Production Fun Fact (Eggs) <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2024",
      },
    ];
    this.data = [
      { x: -140, y: 50, w: 420, h: 320 },
      { x: 330, y: 255, w: 300, h: 400 },
      { x: 831, y: 158, w: 200, h: 300 },
      { x: 1821, y: 200, w: 300, h: 400 },
      { x: 1974, y: 687, w: 260, h: 290 },
      { x: 2323, y: 824, w: 205, h: 300 },
      { x: 911, y: 540, w: 260, h: 280 },
      { x: 1251, y: 803, w: 500, h: 300 },
      { x: 1371, y: 422, w: 350, h: 260 },
      { x: -167, y: 444, w: 350, h: 260 },
      { x: 511, y: 922, w: 205, h: 400 },
      { x: 911, y: 1130, w: 205, h: 400 },
      { x: 1311, y: 23, w: 350, h: 260 },
      { x: 1711, y: 1088, w: 300, h: 220 },
    ];
    // 获取id为hero的元素，设置背景为一段视频src\static\img\page4\bg1.MP4
    // const hero = document.querySelector("#hero");
    // hero.style.background = `url('../../static/img/page4/bg1.MP4') no-repeat center center`;
