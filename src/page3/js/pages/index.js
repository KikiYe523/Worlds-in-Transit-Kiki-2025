...
export default class Index {
  constructor() {
    ...
    this.sources = [
      {
        type: "model",
        src: `${import.meta.env.VITE_MODEL_PATH_PREFIX}/model/cat3.glb`,
        detail:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page3/image-3.jpg",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page3/image-4.jpg",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page3/image-5.jpg",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page3/image-6.jpg",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page3/video-1.mp4",
        caption:
      ...
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page3/video-2.MP4",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page3/video-3.mp4",
        caption:
          "Production Fun Fact (Eggs) <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2024",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page3/image-7.jpg",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page3/image-8.jpg",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page3/image-9.jpg",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page3/image-10.jpg",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page3/image-11.jpg",
        caption:
          "Toilet Paper <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2022",
      },
      {
        ...
        detail:
          "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates.",
        src: "../../static/img/page3/video-4.MP4",
        caption:
          "Production Fun Fact (Eggs) <br>12 x 16 inch C type hand print <br>Edition of 1 Plus an additional artist Proof <br>2024",
      },
    ];
    this.data = [
      { x: 2650, y: 924, w: 400, h: 270 },
      { x: -130, y: 38, w: 205, h: 300 },
      { x: 330, y: 255, w: 250, h: 360 },
      { x: 831, y: 158, w: 200, h: 300 },
      { x: 1921, y: 100, w: 300, h: 400 },
      { x: 1974, y: 687, w: 260, h: 290 },
      { x: 911, y: 640, w: 300, h: 260 },
      { x: 1251, y: 803, w: 500, h: 300 },
      { x: 1371, y: 422, w: 350, h: 260 },
      { x: -167, y: 544, w: 350, h: 260 },
      { x: 511, y: 922, w: 205, h: 400 },
      { x: 911, y: 1130, w: 400, h: 205 },
      { x: 1311, y: 23, w: 350, h: 260 },
      { x: 1711, y: 922, w: 280, h: 360 },
      { x: 1974, y: 1130, w: 205, h: 300 },
      { x: 2221, y: 1130, w: 300, h: 205 },
    ];
    // 获取id为hero的元素，设置背景为一段视频src\static\img\page3\bg1.MP4
    // const hero = document.querySelector("#hero");
    // hero.style.background = `url('../../static/img/page3/bg1.MP4') no-repeat center center`;
